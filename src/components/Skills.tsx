		...
		<div className="px-4 sm:px-6 lg:px-16 pb-10">
			...
			<div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-4 justify-items-center pb-10">
				{images.map((image, i) => (
					<div
						key={i}
						className="relative w-32 h-32 rounded-full drop-shadow-lg hover:scale-110 transition-transform duration-500 ease-in-out flex items-center justify-center overflow-hidden"
					>
						<img
							src={image.src}
